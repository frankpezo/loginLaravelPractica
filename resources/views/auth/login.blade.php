...
@section('content')
    <section>
        <div class="container mt-5 pt-5 ">
            <div class="row d-flex justify-content-center aligns">
                            ...
                            <div class="card-body">
                                ...
                                <form action="">
                                    <div class="mb-3">
                                        ...
                                        <input type="nombre" class="form-control my-3 p-y3"" name="nombre" id="nombre">
                                    </div>

                                    <div class="mb-3">
                                        <label for="apellido">Apellido</label>
                                        <input type="apellido" class="form-control my-3 p-y3"" name="apellido"
                                            id="apellido">
                                    </div>
                                    ...
                                    <button type="button" class="btn btn-dark form-control my-3 p-y3">Registrarse</button>
